...
public class ItemClient extends BaseClient {
    ...
    public ResponseEntity<Object> getItemFromUser(long userId, long itemId) {
    ...
    public ResponseEntity<Object> addCommentInItem(long userId, long itemId, CommentDto comment) {
